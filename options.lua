...
function options.draw()
	...
	lg.printf("CONFIGURAR", 0, 37, WIDTH, "center")
	lg.print("ESCALA:", 65, 63)		lg.print(config.scale, 167, 63)
	lg.print("TELA CHEIA:", 65, 76)
	...
	lg.print("SOM VOL:", 65, 102)	lg.print(math.floor(config.sfx_volume*10+0.01), 167, 102)
	lg.print("MUSICA VOL:", 65, 115)	lg.print(math.floor(config.music_volume*10+0.01), 167, 115)
	lg.print("TECLADO", 65, 128)
	lg.print("JOYSTICK", 65, 141)
	lg.print("VOLTAR", 65, 154)
