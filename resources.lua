...
NO_CASUALTIES_MESSAGES = {
	"LEMBRE-SE: SEU TRABALHO, E RESGATE DE PESSOAS.\nNAO APAGAR O FOGO!",
	"CONTINUE O BOM TRABALHO, CARA!\nVOCE ESTA PEGANDO FOGO.\nHE HE HE",
	"LEMBRE-SE DE OLHAR O LOCAL PARA UPGRADES.\nELES SAO UTEIS",
	"NAO QUER GASTAR AGUA NAS PORTAS?\nJOGUE AS PESSOAS NELAS",
	"RESGATAR 3 OU MAIS PESSOAS EM SUCESSAO GARANTE UM BONUS",
	"LEMBRE-SE: COLETE OS REFRIANTES, POIS SAO ESSENCIAS PARA SUA SOBREVIVENCIA"
}

WON_MESSAGES = {
	{"PARABENS!","","VOCE DERROTOU O SR. MAGMA HULK","E SALVOU AS PESSOAS DO EDIFICIL PEQUENO",
	 "","MAS NOSSO TRABALHO NAO ACABOU","TEMOS MAIS OUTRO!","","MÃOS A OBRAS"},
	{"PARABENS!","","VOCE DERROTOU O SR. VAZAMENTO!","E SALVOU AS PESSOAS DO COMPLEXO APARTAMENTOS",
	 "","MAS NOSSO TRABALHO NAO ACABOU","TEMOS MAIS OUTRO!","","MÃOS A OBRAS"},
	{"PARABENS!","","VOCE DERROTOU O SR. CARVAO","E SALVOU AS PESSOAS DA GRANDE CORPORACAO",
	 "","VOCE É FANTASTICO","SR. RESGATE ESTRELA EM NOSSO CORACAO!","","AGORA DESCANSE"}
}
...
BUILDING_NAMES = {{"PEQUENO","EDIFICIL"},{"COMPLEXO","APARTAMENTOS"},{"GRANDE","CORPORACAO"}}
...
stats_names = {
	...
	"DISTANCIA MOVIDA",     -- 3
	"PESSOAS RESGATADO",     -- 4
	"DANO DE PROPRIEDADE",    -- 5
	"ANDARES SUBIDOS"       -- 6
}

stats_units = { nil, " LITROS", " METROS", nil, " $", nil }
